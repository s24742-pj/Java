...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("minivan przewozi " + miniVan.getPassangers() + " osob na odleglosc do " + rangeV + " kilometorw");
        System.out.println("Sportowe auto przewozi " + sportCar.getPassangers() + " osoby na odleglosc do " + rangeC + " kilometorw");
